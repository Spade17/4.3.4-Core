...
enum AchievementFlags
{
	...
	ACHIEVEMENT_FLAG_REALM_FIRST_RAID_REACH  = 0x00000300,   // ACHIEVEMENT_FLAG_SERVER_FIRST_RAID
...
enum CurrencyTypes
{
    ...
    CURRENCY_TIPE_ARCHEAOLOGY_DWARF     = 384,
    CURRENCY_TIPE_ARCHEAOLOGY_DRAENEI   = 398,
    CURRENCY_TIPE_ARCHEAOLOGY_FOSSIL    = 393,
    CURRENCY_TIPE_ARCHEAOLOGY_NERUBIAN  = 400,
    CURRENCY_TIPE_ARCHEAOLOGY_NIGHT_ELF = 394,
    CURRENCY_TIPE_ARCHEAOLOGY_ORC       = 397,
    CURRENCY_TIPE_ARCHEAOLOGY_TOLVIR    = 401,
    CURRENCY_TIPE_ARCHEAOLOGY_TROLL     = 385,
    CURRENCY_TIPE_ARCHEAOLOGY_VRYKUL    = 399,
};
