...
class Unit : public WorldObject
{
    public:
        ...
        void Dismount(bool from_aura = false);
        ...
        uint32 GetPlayerDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_RESILIENCE_PLAYER_DAMAGE_TAKEN, 1.065f, 100.0f, damage); }
        ...
        */
        ...
        bool HasAuraType(AuraType auraType = SPELL_AURA_NONE) const;
        ...
        void RewardRage(uint32 baseRage, bool attacker, bool isPhysical = false);
