...
namespace Movement
{
    ...
    int32 MoveSplineInit::Launch()
    {
        ...
        // don't calculate real_position if we are already on transport or we get wrong coordinates
		else if (!move_spline.Finalized() && move_spline.onTransport == (unit->GetTransGUID() != 0))
