    ...
    switch (spellproto->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_ROGUE:
        {
			...
			// Cheap Shot
                ...
                return DIMINISHING_OPENING_STUN;
			// Sap
			else if (spellproto->Id == 6770)
				return DIMINISHING_CONTROLLED_STUN;
			else if (spellproto->Id == 408)
				return DIMINISHING_OPENING_STUN;
    ...
    for (uint32 i = 0; i < mSpellInfoMap.size(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 31344: // Howl of Azgalor
                ...
                break;
			//Skull Bash Charge Effect
            case 93983:
				spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_10_YARDS_2); // 20 yards
				break;
