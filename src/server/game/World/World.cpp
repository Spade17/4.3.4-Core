...
void World::LoadConfigSettings(bool reload)
{
	...
	m_bool_configs[CONFIG_ALLOW_TWOSIDE_MAIL] = ConfigMgr::GetBoolDefault("AllowTwoSide.Interaction.Mail", false);
	...
	m_int_configs[CONFIG_PACKET_SPOOF_POLICY] = ConfigMgr::GetIntDefault("PacketSpoof.Policy", (uint32)WorldSession::DosProtection::Policy::POLICY_KICK);
