...
void WorldSession::HandleReforgeItemOpcode(WorldPacket& recvData)
{
    ...
    {
        sLog->outError(LOG_FILTER_NETWORKIO, "Item %u was been alrdy reforged!");
        return;
    }
    ...
    player->ApplyEnchantment(item, REFORGE_ENCHANTMENT_SLOT, false);
    ...
    player->ApplyEnchantment(item, REFORGE_ENCHANTMENT_SLOT, true);
}