...
# define TRALL_MENU "We're ready!" 
# define TELE_MENU_1 "Area 1" 
# define TELE_MENU_2 "Area 2" 
# define TELE_MENU_3 "Area 3" 
# define TELE_MENU_4 "Area 4"
...
public:
    ...
    {
        boss_deathwingAI(Creature* creature) : BossAI(creature, BOSS_MADNESS_OF_DEATHWING)/*vehicle(creature->GetVehicleKit())*/
        {
