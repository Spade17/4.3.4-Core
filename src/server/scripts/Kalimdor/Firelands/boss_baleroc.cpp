...
class spell_vital_flame : public SpellScriptLoader
{
    public:
        ...
        private:
            ...
            void Register()
            {
                OnEffectApply += AuraEffectApplyFn(spell_vital_flame_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_MOD_HEALING_DONE_ON_DEBUFF, AURA_EFFECT_HANDLE_REAL);
                OnEffectRemove += AuraEffectRemoveFn(spell_vital_flame_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_MOD_HEALING_DONE_ON_DEBUFF, AURA_EFFECT_HANDLE_REAL);
            }
        };
