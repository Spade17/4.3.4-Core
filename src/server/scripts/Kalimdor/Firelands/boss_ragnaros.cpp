...
class boss_ragnaros_firelands : public CreatureScript
{
    public:
        ...
        {
            boss_ragnaros_firelandsAI(Creature* creature) : BossAI(creature, BOSS_RAGNAROS), summons(me)
            {
            ...
            {
                if (instance)
					instance->SetBossState(BOSS_RAGNAROS, NOT_STARTED);
		    ...
		    void EnterEvadeMode()
            {
			    ...
			    if (instance)
                {
					instance->SetBossState(BOSS_RAGNAROS, FAIL);
            ...
            void JustDied(Unit * /*victim*/)
            {
                ...
                if (instance)
                {
					instance->SetBossState(BOSS_RAGNAROS, DONE);
                    instance->SendEncounterUnit(ENCOUNTER_FRAME_DISENGAGE, me); // Remove
                }
            ...
            void EnterCombat(Unit* who)
            {
                ...
                if (instance)
                {
					instance->SetBossState(BOSS_RAGNAROS, IN_PROGRESS);
            ...
            void JustSummoned(Creature *summon)
            {
                ...
                switch (summon->GetEntry())
                {
                    ...
                    case NPC_PLATFORM_STALKER:
                        ...
                        summon->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_DISABLE_MOVE|UNIT_FLAG_NON_ATTACKABLE|UNIT_FLAG_NOT_SELECTABLE);
                        if (Creature* ragnaros = me->FindNearestCreature(BOSS_RAGNAROS, 40.0f, true))
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_RAGE_OF_RAGNAROS:
                            ...
                            {
                                std::list<HostileReference*> const& m_threatlist = me->getThreatManager().getThreatList();
    ...
    public:
        ...
        struct npc_entrapping_rootsAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 uiDiff)
            {
                ...
                {
                    if (Creature* Ragnaros = me->FindNearestCreature(BOSS_RAGNAROS, 10.0f, true)) //remember NPC_RAGNAROS_FIRELANDS = 52409
                    {
