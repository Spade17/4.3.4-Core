    ...
    public:
        ...
        struct boss_bethtilacAI : public BossAI
        {
            ...
            void EnterCombat(Unit* victim)
            {
                ...
                events.ScheduleEvent(EVENT_SUMMON_CINDERWEB_SPINNER, urand(8000, 10000), 0);
                events.ScheduleEvent(EVENT_DECREASE_ENERGY, 1000, 0);
                events.ScheduleEvent(EVENT_METEOR_BURN, urand(15000, 18000), 0);
                events.ScheduleEvent(EVENT_SUMMON_SPILDERING, urand(40000, 60000), 0);
                events.ScheduleEvent(EVENT_SUMMON_DRONE, urand(35000, 40000), 0);
                ...
                while (uint32 eventid = events.ExecuteEvent())
                {
                    switch (eventid)
                    {
                        ...
                        case EVENT_SUMMON_CINDERWEB_SPINNER:
                            ...
                            spinnerCount++;
                            if (spinnerCount <= RAID_MODE(6, 15))
                                events.ScheduleEvent(EVENT_SUMMON_CINDERWEB_SPINNER, urand(2000, 3000), 0);
                            else
                            {
                                spinnerCount = 0;
                            }
                        ...
                        case EVENT_SMOLDERING_DEVASTATION:
                            ...
                            if (phase == 0)
                            {
                                events.ScheduleEvent(EVENT_SUMMON_CINDERWEB_SPINNER, urand(3000, 4000), 0);
                                events.ScheduleEvent(EVENT_SUMMON_SPILDERING, urand(40000, 55000), 0);
                        ...
                        case EVENT_SUMMON_SPILDERING:
                        {
                            uint8 pos = urand(0, 2);
                            for (uint8 i = 0; i < 5; i++)
                                me->SummonCreature(53631, spilderingSummonPos[pos]);
                            break;
                        }
                        ...
                        case EVENT_EMBER_FLARE:
                            ...
                            events.ScheduleEvent(EVENT_EMBER_FLARE, urand(7000, 8000), 1);
                            break;
                        case EVENT_FRENZY:
...
class npc_cinderweb_spinner : public CreatureScript
{
    public:
        ...
        struct npc_cinderweb_spinnerAI : public ScriptedAI
        {
            ...
            {
                events.ScheduleEvent(EVENT_BURNING_ACID, urand(6000, 8000));
            }
