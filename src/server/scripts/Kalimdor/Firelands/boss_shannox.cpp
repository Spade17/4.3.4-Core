/*Copyright (C) 2012 SkyMist Project (Script Coded by Naios, completed by Hellground).
*
* Script 90% done. TODO:
*
...
enum Shannox_Yells
{
	...
	SAY_ON_KILL_TWO			    = 11,
	SAY_BURN_TWO			    = 12,
	SAY_INTRO_SPECH_PART_ONE    = 13,
	SAY_INTRO_SPECH_PART_TWO    = 14
};
...
const int ShannoxSpearEquipmentTemplate      = 2;
...
public:
	...
	{
		boss_shannoxAI(Creature* c) : BossAI(c, BOSS_SHANNOX)
		{
        ...
        void EnterEvadeMode()
        {
			...
			if (instance)
                instance->SetBossState(BOSS_SHANNOX, FAIL);
...
public:
	...
	struct npc_ragefaceAI : public ScriptedAI
	{
		...
		Creature* GetShannox()
		{
			return me->FindNearestCreature(BOSS_SHANNOX, 5000.0f, true);
		}
