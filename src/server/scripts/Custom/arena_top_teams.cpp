...
class arena_top_teams : public CreatureScript
{
	...
	{
		player->ADD_GOSSIP_ITEM(4,"|cff00ff00|TInterface\\icons\\spell_chargepositive:26|t|r How does this npc work?", GOSSIP_SENDER_MAIN, ARENA_HELP);
		...
		player->ADD_GOSSIP_ITEM(4,"|cff00ff00|TInterface\\icons\\Achievement_Arena_5v5_7:26|t|r Top 10: 1v1 Arena", GOSSIP_SENDER_MAIN, ARENA_1V1_LADDER);
