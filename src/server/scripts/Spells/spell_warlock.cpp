    ...
    class spell_warl_soul_swap_exhale_SpellScript : public SpellScript
    {
        ...
        void HandleOnCast()
        {
            ...
            if (caster->HasAura(SPELL_WARLOCK_SOUL_SWAP_GLYPH))
                caster->CastSpell(caster, SPELL_WARLOCK_SOUL_SWAP_COOLDOWN, true);
        }
        ...
        void HandleEffectHit(SpellEffIndex /*effIndex*/)
        {
            ...
            if (caster->CastSavedSoulSwapDots(target) && !caster->HasAura(SPELL_WARLOCK_SOUL_SWAP_GLYPH))
...
class spell_warl_demonic_circle_teleport : public SpellScriptLoader
{
    public:
        ...
        class spell_warl_demonic_circle_teleport_AuraScript : public AuraScript
        {
			...
			bool Validate(SpellInfo const* /*spell*/)
			{
                 if (!sSpellMgr->GetSpellInfo(SPELL_WARLOCK_DEMONIC_CIRCLE_ALLOW_CAST))
                     return false;
                 return true;
            }
