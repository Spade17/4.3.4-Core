...
// 51753 - Camouflage
class spell_hun_camouflages : public SpellScriptLoader
{
    public:
        spell_hun_camouflages() : SpellScriptLoader("spell_hun_camouflages") { }

        class spell_hun_camouflages_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_hun_camouflages_SpellScript);
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_hun_camouflages_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_hun_camouflages_SpellScript();
        }
};
