...
enum NitroBoots
{
    SPELL_NITRO_BOOTS_SUCCESS       = 55004, // 54861 is default id but from what i can see it's the wrong nitro boots spell id and that's why it doesn't work, will try to change it to the other one. 
...
enum spell_item_Grounded_Plasma_Shield_Spells
{
    SPELL_spell_item_Grounded_Plasma_Shield_SUCESS = 82627, // Proc 18k absorb
...
public:
    ...
    class spell_item_Grounded_Plasma_Shield_SpellScript : public SpellScript
    {
        ...
        bool Validate(SpellInfo const* /*spell*/)
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_spell_item_Grounded_Plasma_Shield_SUCESS) || !sSpellMgr->GetSpellInfo(SPELL_Reversed_Shield) || !sSpellMgr->GetSpellInfo(SPELL_Magnetized) || !sSpellMgr->GetSpellInfo(SPELL_Painful_Shock))
                return false;
            return true;
        }
        ...
        void HandleDummy(SpellEffIndex /* effIndex */)
        {
            ...
            caster->CastSpell(caster, roll_chance_i(95) ? SPELL_spell_item_Grounded_Plasma_Shield_SUCESS : SPELL_Reversed_Shield, true, GetCastItem());
        }
