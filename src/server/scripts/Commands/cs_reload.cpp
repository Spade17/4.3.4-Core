...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
			...
			{ "item_template",                SEC_ADMINISTRATOR, true,  &HandleReloadItemPrototypesCommand,             "", NULL },
            { "gameobject_template",          SEC_ADMINISTRATOR, true,  &HandleReloadGameobjectInfoCommand,             "", NULL },
            { "creature_template",            SEC_ADMINISTRATOR, true,  &HandleReloadCreatureTemplatesCommand,          "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
		...
		HandleReloadItemPrototypesCommand(handler, "");
        HandleReloadGameobjectInfoCommand(handler, "");
        HandleReloadCreatureTemplatesCommand(handler, "");
	...
	static bool HandleReloadItemPrototypesCommand(ChatHandler* handler, const char* /*args*/)
	{
		sLog->outInfo(LOG_FILTER_GENERAL, "Loading Item Data... (`item_template`)" );
		sObjectMgr->LoadItemTemplates();
		handler->SendGlobalGMSysMessage("DB table `item_template` reloaded.");
		return true;
	}

    static bool HandleReloadGameobjectInfoCommand(ChatHandler* handler, const char* /*args*/)
	{
		sLog->outInfo(LOG_FILTER_GENERAL, "Loading Gameobject Data... (`gameobject_template`)" );
		sObjectMgr->LoadGameObjectTemplate();
		handler->SendGlobalGMSysMessage("DB table `gameobject_template` (gameobject data) reloaded.");
		return true;
	}

    static bool HandleReloadCreatureTemplatesCommand(ChatHandler* handler, const char* /*args*/)
	{
		sLog->outInfo(LOG_FILTER_GENERAL, "Loading Creature Data... (`creature_template`)" );
		sObjectMgr->LoadCreatureTemplates();
		handler->SendGlobalGMSysMessage("DB table `creature_template` (creature data) reloaded.");
		return true;
	}
